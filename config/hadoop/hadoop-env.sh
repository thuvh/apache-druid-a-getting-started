...
export HADOOP_HOME=/home/worker/hadoop-3.1.1
...
export HDFS_NAMENODE_USER=worker
export HDFS_DATANODE_USER=worker
export HDFS_SECONDARYNAMENODE_USER=worker
export YARN_RESOURCEMANAGER_USER=worker
export YARN_NODEMANAGER_USER=worker
